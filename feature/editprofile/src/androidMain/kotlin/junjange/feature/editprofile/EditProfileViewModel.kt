...
class EditProfileViewModel
    constructor(
        ...
        fun postImagesUpload() {
            launch {
                _uiState.value.profileImageFile?.let { rawFile -> val file = rawFile as java.io.File
        ...
        fun setImageFile(file: Any) { // TODO: Replace with multiplatform file abstraction
            _uiState.update {
                it.copy(profileImageFile = file)
            }
        }

        fun onPickImage(bitmap: Any) { // TODO: Replace with multiplatform image abstraction
            _uiState.update {
                it.copy(
