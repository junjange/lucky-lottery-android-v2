...
import junjange.feature.withdrawal.dialog.WithdrawalDialog
import junjange.feature.withdrawal.resources.*
import junjange.feature.withdrawal.resources.back_to_title
import junjange.feature.withdrawal.resources.ic_back
import junjange.feature.withdrawal.resources.thanks_for_playing
import junjange.feature.withdrawal.resources.thanks_for_playing_description
import junjange.feature.withdrawal.resources.withdrawal
import junjange.feature.withdrawal.resources.withdrawal_question
        ...
        topBar = {
            if (uiState.step < 2) {
                LottoSimpleTopBar(
                    ...
                    backIconRes = Res.drawable.ic_back,
                    titleRes = Res.string.withdrawal,
                )
            }
        },
    ) { innerPadding ->
        when (uiState.step) {
            1 -> {
                Column(
                    ...
                    Text(
                        text = stringResource(Res.string.withdrawal_question),
            ...
            2 -> {
                Column(
                    ...
                    Text(
                        text = stringResource(Res.string.thanks_for_playing),
                        style = LottoTheme.typography.headline1,
                        modifier = Modifier.padding(horizontal = 36.dp),
                    )
                    Spacer(modifier = Modifier.height(18.dp))
                    Text(
                        text = stringResource(Res.string.thanks_for_playing_description),
