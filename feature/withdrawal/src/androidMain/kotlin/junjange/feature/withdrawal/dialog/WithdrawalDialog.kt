package junjange.feature.withdrawal.dialog
...
import junjange.feature.withdrawal.resources.button_done
import junjange.feature.withdrawal.resources.dialog_description
import junjange.feature.withdrawal.resources.dialog_title
...
private fun WithdrawalDialogContent(okClick: () -> Unit) {
    Surface(
        ...
        Column {
            Text(
                text = stringResource(Res.string.dialog_title),
                modifier = Modifier.padding(16.dp),
                style = LottoTheme.typography.headline3,
                color = LottoTheme.colors.lottoBlack,
            )
            Text(
                text = stringResource(Res.string.dialog_description),
